...
class MovingAgent {
    ...
    canMoveLeft() {
        var tile = this.map.getTileRowColumn(this.x - this.fullRadius + 1 -2, this.y);          //checks if the neighbouring left tile has any obstacle
        if (this.map.canTileBeVisited(tile.row, tile.col)) {
            var tileCoors = this.map.getTileCoordinates(tile.row, tile.col);
            if((tileCoors.y + this.fullRadius) === this.y){
                return true;
    ...
    canMoveUp() {
        var tile = this.map.getTileRowColumn(this.x, this.y - this.fullRadius + 1-2);          //checks if the neighbouring upward tile has any obstacle
        if (this.map.canTileBeVisited(tile.row, tile.col)) {
            var tileCoors = this.map.getTileCoordinates(tile.row, tile.col);
    ...
    canMoveDown() {                                                                                   //checks if the neighbouring downward tile has any obstacle
